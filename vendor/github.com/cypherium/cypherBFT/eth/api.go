...
// PublicEthereumAPI provides an API to access Cypherium full node-related
// information.
type PublicEthereumAPI struct {
	e *Cypherium
}

// NewPublicEthereumAPI creates a new Cypherium protocol API for full nodes.
func NewPublicEthereumAPI(e *Cypherium) *PublicEthereumAPI {
...
func (api *PublicEthereumAPI) Exceptions(blockNumber int64) []string {
	return api.e.Exceptions(blockNumber)
}

func (api *PublicEthereumAPI) TakePartInNumberList(address common.Address, blockNumber rpc.BlockNumber) []string {
...
func NewPrivateAdminAPI(eth *Cypherium) *PrivateAdminAPI {
...
func NewPublicDebugAPI(eth *Cypherium) *PublicDebugAPI {
...
func NewPrivateDebugAPI(config *params.ChainConfig, eth *Cypherium) *PrivateDebugAPI {
