...
// PublicEthereumAPI provides an API to access Cypherium related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new Cypherium protocol API.
...
func (s *PublicEthereumAPI) CommitteeMembers(ctx context.Context, blockNr rpc.BlockNumber) ([]*common.Cnode, error) {

	c, err := s.b.CommitteeMembers(ctx, blockNr)
	return c, err
}

func (s *PublicEthereumAPI) CommitteeExceptions(ctx context.Context, blockNr rpc.BlockNumber) []string {
	return s.b.Exceptions(int64(blockNr))
}

func (s *PublicEthereumAPI) TakePartInNumbers(ctx context.Context, addr common.Address, blockNr rpc.BlockNumber) []string {
...
//
// https://github.com/cypherium/cypherBFT/wiki/Management-APIs#personal_sign
...
//
// https://github.com/cypherium/cypherBFT/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) GetBlockHeadersByNumbers(ctx context.Context, blockNrs []int64) ([]interface{}, error) {
	...
	for _, blockNr := range blockNrs {
		//log.Debug("GetBlockHeadersByNumbers", "block", blockNr)
...
//
// https://github.com/cypherium/wiki/wiki/JSON-RPC#eth_sign
