...
var (
	KeyChainBadHashes    = map[common.Hash]bool{}
	KeyChainRollBackHash = common.Hash{}

	TxChainRollBackHash = common.Hash{}
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/cypherium/EIPs/issues/150)
...
// CphashConfig is the consensus engine configs for proof-of-work based sealing.
type CphashConfig struct{}
