...
!define HELPURL "https://github.com/cypherium/cypherBFT/issues"
!define UPDATEURL "https://github.com/cypherium/cypherBFT/releases"
!define ABOUTURL "https://github.com/cypherium/cypherBFT#cypherium-go"
...
Section "Cypher" GCPH_IDX
  ...
  SimpleFC::AdvRemoveRule "Cypher incoming peers (TCP:9090)"
  SimpleFC::AdvRemoveRule "Cypher outgoing peers (TCP:9090)"
  SimpleFC::AdvRemoveRule "Cypher UDP discovery (UDP:9090)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Cypher incoming peers (TCP:9090)" ""  6 1 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Cypherium" 9090 "" "" ""
  SimpleFC::AdvAddRule "Cypher outgoing peers (TCP:9090)" ""  6 2 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Cypherium" "" 9090 "" ""
  SimpleFC::AdvAddRule "Cypher UDP discovery (UDP:9090)" "" 17 2 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Cypherium" "" 9090 "" ""
