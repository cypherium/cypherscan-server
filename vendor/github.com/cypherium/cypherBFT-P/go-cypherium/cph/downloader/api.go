...
// Syncing provides information when this nodes starts synchronising with the Cypherium network and when it's finished.
...
type SyncingResult struct {
	...
	Status  cypherI.SyncProgress `json:"status"`
}
