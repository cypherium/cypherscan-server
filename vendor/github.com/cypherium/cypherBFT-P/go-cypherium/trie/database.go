...
type Database struct {
	diskdb cphdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb cphdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch cphdb.Batch) error {
