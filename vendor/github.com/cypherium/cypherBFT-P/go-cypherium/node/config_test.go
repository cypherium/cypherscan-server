...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "cypher.ipc", false, filepath.Join(os.TempDir(), "cypher.ipc")},
		{"data", "cypher.ipc", false, "data/cypher.ipc"},
		{"data", "./cypher.ipc", false, "./cypher.ipc"},
		{"data", "/cypher.ipc", false, "/cypher.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "cypher.ipc", true, `\\.\pipe\cypher.ipc`},
		{"data", "cypher.ipc", true, `\\.\pipe\cypher.ipc`},
		{"data", `\\.\pipe\cypher.ipc`, true, `\\.\pipe\cypher.ipc`},
	}
