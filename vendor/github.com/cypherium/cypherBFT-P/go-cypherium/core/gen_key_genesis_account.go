...
var _ = (*keyGenesisAccountMarshaling)(nil)
...
func (g *GenesisKeyAccount) UnmarshalJSON(input []byte) error {
	...
	if dec.Balance == nil {
		return errors.New("missing required field 'balance' for GenesisKeyAccount")
	}
