...
func (b *KeyBlock) SetDifficulty(dif *big.Int) { b.header.Time = dif }
func (b *KeyBlock) Time() *big.Int             { return new(big.Int).Set(b.header.Time) }
func (b *KeyBlock) SetTime(time *big.Int)      { b.header.Time = time }
