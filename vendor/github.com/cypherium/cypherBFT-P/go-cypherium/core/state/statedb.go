...
// StateDBs within the cypherium protocol are used to store anything
...
//
// Carrying over the balance ensures that Cpher doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/cypherium/cypherBFT-P/go-cypherium/pull/16485#issuecomment-380438527),
