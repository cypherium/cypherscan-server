Name "cypher ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/cypherium/cypherBFT-P/go-cypherium/issues"
!define UPDATEURL "https://github.com/cypherium/cypherBFT-P/go-cypherium/releases"
!define ABOUTURL "https://github.com/cypherium/cypherBFT-P#cypherium-go"
...
# Install cypher binary
Section "Cypher" GCPH_IDX
  SetOutPath $INSTDIR
  file {{.Cypher}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\cypher.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\cypher.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Cypher incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Cypher outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Cypher UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Cypher incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Cypherium" 30303 "" "" ""
  SimpleFC::AdvAddRule "Cypher outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Cypherium" "" 30303 "" ""
  SimpleFC::AdvAddRule "Cypher UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\cypher.exe" "" "" "Cypherium" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/cypherium/EIPs/issues/147)
  ${EnvVarUpdate} $0 "Cphereum_SOCKET" "R" "HKLM" "\\.\pipe\cypher.ipc"
  ${EnvVarUpdate} $0 "Cphereum_SOCKET" "A" "HKLM" "\\.\pipe\cypher.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GCPH_IDX}
    SectionGetSize ${GCPH_IDX} $0
