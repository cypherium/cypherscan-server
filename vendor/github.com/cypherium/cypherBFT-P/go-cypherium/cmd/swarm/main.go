...
import (
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/cmd/utils"
	"github.com/cypherium/cypherBFT-P/go-cypherium/common"
	"github.com/cypherium/cypherBFT-P/go-cypherium/console"
	"github.com/cypherium/cypherBFT-P/go-cypherium/crypto"
	"github.com/cypherium/cypherBFT-P/go-cypherium/internal/debug"
	"github.com/cypherium/cypherBFT-P/go-cypherium/log"
	"github.com/cypherium/cypherBFT-P/go-cypherium/node"
	"github.com/cypherium/cypherBFT-P/go-cypherium/p2p"
	"github.com/cypherium/cypherBFT-P/go-cypherium/p2p/discover"
	"github.com/cypherium/cypherBFT-P/go-cypherium/params"
	"github.com/cypherium/cypherBFT-P/go-cypherium/swarm"
	bzzapi "github.com/cypherium/cypherBFT-P/go-cypherium/swarm/api"
	swarmmetrics "github.com/cypherium/cypherBFT-P/go-cypherium/swarm/metrics"
...
var (
	...
	testbetBootNodes = []string{
		"cnode://ec8ae764f7cb0417bdfb009b9d0f18ab3818a3a4e8e7c67dd5f18971a93510a2e6f43cd0b69a27e439a9629457ea804104f37c85e41eed057d3faabbf7744cdf@13.74.157.139:30429",
		"cnode://c2e1fceb3bf3be19dff71eec6cccf19f2dbf7567ee017d130240c670be8594bc9163353ca55dd8df7a4f161dd94b36d0615c17418b5a3cdcbb4e9d99dfa4de37@13.74.157.139:30430",
		"cnode://fe29b82319b734ce1ec68b84657d57145fee237387e63273989d354486731e59f78858e452ef800a020559da22dcca759536e6aa5517c53930d29ce0b1029286@13.74.157.139:30431",
		"cnode://1d7187e7bde45cf0bee489ce9852dd6d1a0d9aa67a33a6b8e6db8a4fbc6fcfa6f0f1a5419343671521b863b187d1c73bad3603bae66421d157ffef357669ddb8@13.74.157.139:30432",
		"cnode://0e4cba800f7b1ee73673afa6a4acead4018f0149d2e3216be3f133318fd165b324cd71b81fbe1e80deac8dbf56e57a49db7be67f8b9bc81bd2b7ee496434fb5d@13.74.157.139:30433",
	}
)
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Cypherium API provider to use to settle SWAP payments",
	...
	SwarmStorePath = cli.StringFlag{
		Name:   "store.path",
		Usage:  "Path to leveldb chunk DB (default <$GCPH_ENV_DIR>/swarm/bzz-<$BZZ_KEY>/chunks)",
...
// This init function sets defaults so cmd/swarm can run alongside cypher.
func init() {
...
var app = utils.NewApp(gitCommit, "Cypherium Swarm")
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.cypherium/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.cypherium/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:             dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.cypherium/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.cypherium/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:             dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//cypher only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for cypher and swarm
	if _, err := os.Stat(bzzconfig.Path); err == nil {
		cfg.DataDir = bzzconfig.Path
	}
	//setup the cypherium node
	...
	//register BZZ as node.Service in the cypherium node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the cypherium node
