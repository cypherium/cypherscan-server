...
import (
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Cypherium contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Cypherium contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Cypherium contract Solidity source to build and bind")
