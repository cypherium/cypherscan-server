...
import (
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/cmd/evm/internal/compiler"
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/core/vm/runtime"
...
func runCmd(ctx *cli.Context) error {
	...
	if ctx.GlobalString(GenesisFlag.Name) != "" {
		...
		statedb, _ = state.New(common.Hash{}, state.NewDatabase(cphdb.NewMemDatabase()))
	}
