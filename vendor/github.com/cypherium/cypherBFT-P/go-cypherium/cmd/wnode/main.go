...
import (
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/whisper/mailserver"
...
func initialize() {
	...
	if *bootstrapMode {
		...
		*bootstrapMode = true
		...
		if len(*argEnode) == 0 {
			argEnode = scanLineA("Please enter the peer's cnode: ")
		}
...
func extractIDFromEnode(s string) []byte {
	...
	if err != nil {
		utils.Fatalf("Failed to parse cnode: %s", err)
	}
	return n.ID[:]
}
