...
// available in the database. It initialises the default Cypherium header
// validator.
func NewLightChain(odr OdrBackend, config *params.ChainConfig, engine pow.Engine) (*LightChain, error) {
...
// Engine retrieves the light chain's pow engine.
func (bc *LightChain) Engine() pow.Engine { return bc.engine }
