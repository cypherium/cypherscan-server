...
import (
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/internal/jsre"
	"github.com/cypherium/cypherBFT-P/go-cypherium/internal/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	if c.prompter != nil {
		...
		if obj := miner.Object(); obj != nil {
			if _, err = c.jsre.Run(`jeth.startMiner = miner.start;`); err != nil {
				return fmt.Errorf("miner.start: %v", err)
			}

			obj.Set("start", bridge.StartMiner)
		}
	}
...
// Welcome show summary of current Cypher instance and some metadata about the
