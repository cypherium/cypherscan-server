...
// See https://github.com/cypherium/tests/wiki/VM-Tests for the test format specification.
type VMTest struct {
	json vmJSON
}
...
func (t *VMTest) newEVM(statedb *state.StateDB, vmconfig vm.Config) *vm.EVM {
	...
	return vm.NewEVM(context, statedb, params.MainnetChainConfig, vmconfig, nil)
}
