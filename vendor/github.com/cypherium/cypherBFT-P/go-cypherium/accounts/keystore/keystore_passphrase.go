...
import (
	...
	cryptoLocal "github.com/cypherium/cypherBFT-P/go-cypherium/crypto"
	"github.com/cypherium/cypherBFT-P/go-cypherium/crypto/randentropy"
...
func DecryptKey(keyjson []byte, auth string) (*Key, error) {
	...
	return &Key{
		Id:         uuid.UUID(keyId),
		Address:    cryptoLocal.PubKeyToAddressCypherium(publicKey.(ed25519.PublicKey)),
		PrivateKey: keyBytes,
	}, nil
}
