...
var (
	...
	cachetestAccounts = []accounts.Account{
		{
			Address: common.HexToAddress("e1f804d023ae2a5c12e7585c8e7a286766646a6a"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(cachetestDir, "UTC--2018-07-12T05-33-36.306013000Z--e1f804d023ae2a5c12e7585c8e7a286766646a6a")},
		},
		{
			Address: common.HexToAddress("644c7e27471462bcdcec434465c5af34d84bd25f"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(cachetestDir, "aaa")},
		},
		{
			Address: common.HexToAddress("58b972aedadb22d4b65e8f9fe77073f90517b791"),
...
func TestWatchNoDir(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("cph-keystore-watch-test-%d-%d", os.Getpid(), rand.Int()))
...
func TestCacheAddDeleteOrder(t *testing.T) {
	...
	accs := []accounts.Account{
		...
		{
			Address: common.HexToAddress("e1f804d023ae2a5c12e7585c8e7a286766646a6a"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: "UTC--2018-07-12T05-33-36.306013000Z--e1f804d023ae2a5c12e7585c8e7a286766646a6a"},
		},
		{
			Address: common.HexToAddress("644c7e27471462bcdcec434465c5af34d84bd25f"),
