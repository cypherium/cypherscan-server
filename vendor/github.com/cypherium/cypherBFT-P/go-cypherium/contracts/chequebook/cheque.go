...
// issuing, receiving, verifying cheques in cpher; (auto)cashing cheques in cpher
// as well as (auto)depositing cpher to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/contracts/chequebook/contract"
	...
	"github.com/cypherium/cypherBFT-P/go-cypherium/swarm/services/swap/swap"
)
...
// * depositing cpher to the chequebook
// * watching incoming cpher
...
// Cash cashes the cheque by sending an Cypherium transaction.
