...
prjPath="work/src/github.com/cypherium/cypherBFT-P/go-cypherium"
...
ssh  -i ./azure-cypherium-private.pem $username@$ip  "cd $userCphPrjPath; sudo rm -f $binName*.tar.bz2; cd ./build/bin;sudo tar jcvf $binName.tar.bz2 ./cypher;"
scp  -i ./azure-cypherium-private.pem $username@$ip:$userCphPrjPath/build/bin/cypher.tar.bz2 $targetBinPath/linux/cypher.tar.bz2
