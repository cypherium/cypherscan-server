...
listLocation=1
#prjPath=$(pwd)
prjPath="/root/work/src/github.com/cypherium/cypherBFT-P/go-cypherium"
CYPHER="/root/work/src/github.com/cypherium/cypherBFT-P/go-cypherium/build/bin/cypher"
NODE_DIR="$prjPath/chaindb"
BOOTNODE="cnode://098c1149a1476cf44ad9d480baa67d956715b8671a4915bed17d06a1cafd7b154bc1841d451d80d391427ebc48aaa3216d4e8a2b46544dffdc61b76be6475418@13.72.80.40:9090"
...
append_node()
{
    ...
    #log "BOOTNODE is $BOOTNODE"
        ...
        $CYPHER  --onetport 7100 --nat extip:$ip --ws --tps --ipencdis $IPENCDISVALUE --powrangemode $PRMV -wsaddr="0.0.0.0" --wsorigins "*" --rpc --rpccorsdomain "*" --rpcaddr 0.0.0.0 --rpcapi cph,web3,personal,miner,txpool --port $((6000 )) --rpcport $((8000 )) --verbosity "$LOGLEVEL" --datadir "$NODE_DIR/$listLocation" --networkid "$NETWORKID" --gcmode archive --bootnodes "$BOOTNODE" 2>"$NODE_DIR/$listLocation/output.log"
    #popd
}
