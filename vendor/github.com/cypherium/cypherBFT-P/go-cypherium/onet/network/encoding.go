...
// EncSuite is a convenience. It might go away when we decide the a better way to set the
var EncSuite = suites.MustFind("Ed25519")
...
func DumpTypes() {
	for t, m := range registry.types {
		log.Debug("", "Type", t, "has message", m)
	}
}
