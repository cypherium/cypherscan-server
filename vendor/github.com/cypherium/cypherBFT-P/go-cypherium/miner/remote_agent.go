...
func (a *RemoteAgent) GetWork() ([3]string, error) {
	...
	if a.currentWork != nil {
		...
		n := big.NewInt(1)
		n.Lsh(n, 255)
		n.Div(n, candidate.KeyCandidate.Difficulty)
		n.Lsh(n, 1)
		res[2] = common.BytesToHash(n.Bytes()).Hex()

		a.work[candidate.HashNoNonce()] = a.currentWork
		return res, nil
	}
...
func (a *RemoteAgent) SubmitWork(nonce types.BlockNonce, mixDigest, hash common.Hash) bool {
	...
	candidate.KeyCandidate.Nonce = nonce
	candidate.KeyCandidate.MixDigest = mixDigest

	if err := a.engine.VerifyCandidate(a.keyChain, candidate); err != nil {
